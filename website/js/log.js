...
username_span.setAttribute("class", "errorMsg");
username.after(username_span);

let password = document.getElementById('password');
let password_span = document.createElement('span');
password_span.setAttribute("class", "errorMsg");
password.after(password_span);
...
if(signPage){
    password_confirm_span = document.createElement('span');
    password_confirm_span.setAttribute("class", "errorMsg");
    password_confirm.after(password_confirm_span);
}
