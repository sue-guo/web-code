...
Jiayun Wang: design the database structure, implement publish blog function;
implement detail blog function; implement submit comment function; implement display comment function;
-->
<?php
    $pageTitle = 'detail';
